...
CREATE TABLE IF NOT EXISTS `retotrebureus`.`usuario` (
  ...
  `contrasenausu` VARCHAR(80) NOT NULL,
...
-- -----------------------------------------------------
-- Table `retotrebureus`.`sesiones`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `retotrebureus`.`sesiones` ;

CREATE TABLE IF NOT EXISTS `retotrebureus`.`sesiones` (
  `token` VARCHAR(250) NOT NULL,
  `exptoken` INT(100) NOT NULL,
...
CREATE INDEX `fk_producto_usuario2_idx` ON `retotrebureus`.`sesiones` (`idusu` ASC);
...
INSERT INTO `retotrebureus`.`usuario` (`idusu`, `nombreusu`, `contrasenausu`, `nombre`, `gmail`, `tlfno`, `direccion`) VALUES (3, 'cerdan', '03ac674216f3e15c761ee1a5e255f067953623c8b388b4459e13f978d7c846f4', 'roberto', 'roberto.cerdan@ikasle.egibide.org', 944552211, 'arriaga 31');
...
INSERT INTO `retotrebureus`.`imagen` (`idfotos`, `imagenfoto`, `producto_idproducto`, `usuario_idusu`) VALUES (7, 'perfil1.jpg', 1, NULL);
INSERT INTO `retotrebureus`.`imagen` (`idfotos`, `imagenfoto`, `producto_idproducto`, `usuario_idusu`) VALUES (4, 'masters.jpg', 4, NULL);
COMMIT;
