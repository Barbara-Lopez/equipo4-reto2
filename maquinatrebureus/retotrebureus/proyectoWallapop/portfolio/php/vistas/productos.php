...
<body>
    ...
    <fieldset id="formFiltroProductos">
            <form action="?" method="POST">
                <input type="text" id="fFiltro" class="inputBuscador" name="fFiltro">
    ...
    <!--Cambiar a script propio....-->
    <script>consultarProductos();rellenarCategorias();rellenarLocalidades();</script>
</body>
<html>
